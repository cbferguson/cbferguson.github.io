...
const apiKey = urlParams.get("apiKey") || "d5803ddf1257b7a93af961b7c442a4da";
const cityId = urlParams.get("cityId") || "4076598";
...
function getWeather() {
  ...
  return fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=Mobile,al&appid=${apiKey}`,
    requestOptions
  )
